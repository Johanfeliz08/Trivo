...
export default function InteresesPage({ userData, setUserData }) {
  ...
  if (userData.categoriasIntereses && userData.categoriasIntereses.length > 0) {
    userData.categoriasIntereses.map((categoria) => {
                ...
                <div className="interes flex flex-row" key={interes.interesId}>
                  ...
                  <label
                    ...
                    className={`flex relative justify-start items-center rounded-xl border-2 cursor-pointer shadow-sm bg-bg-secondary w-56 h-20 p-5 ${
                      userData.intereses.find((i) => i.interesId === interes.interesId) ? "border-primary" : "border-transparent"
                    }`}
                  >
                    <div className={`icon absolute top-0 right-0 p-1 ${userData.intereses.find((i) => i.interesId === interes.interesId) ? "flex" : "hidden"}`}>
