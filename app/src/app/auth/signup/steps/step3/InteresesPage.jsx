...
export default function InteresesPage({ formData, setFormData }) {
  ...
  // Controlar la paginacion de intereses
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 8; // Cantidad de categorias de intereses por pagina
  const totalPages = Math.ceil(intereses.length / itemsPerPage); // Cantidad de paginas

  // Calcular el indice de inicio y fin de las categorias de intereses a mostrar
  const startIndex = (currentPage - 1) * itemsPerPage;
  const endIndex = startIndex + itemsPerPage;
  const interesesToShow = intereses.slice(startIndex, endIndex);
      ...
      <div className="intereses-container min-h-110 flex flex-row justify-center items-center gap-8">
        ...
        <div className="pagination-container flex flex-col justify-center items-center gap-14">
          <div className="intereses grid grid-cols-2 gap-4 justify-center items-center">
            {interesesToShow.length > 0 ? (
              interesesToShow.map((interes) => (
