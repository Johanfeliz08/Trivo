...
export default function MiPerfilPage() {
  const [user, setUser] = useState({
    ...
    estado: "Disponible",
    ubicacion: "Barahona, Republica Dominicana",
    imagen: "/imagenes/user.jpg",
    biografia: "Desarrollador Full Stack con experiencia en Next.js y React.",
    habilidades: ["JavaScript", "React", "Next.js", "Node.js", "CSS", "HTML"],
    intereses: ["Tecnología", "Desarrollo Web", "Inteligencia Artificial", "Machine Learning"],
  });
        ...
        <div className="miperfil bg-white shadow-xl roundex-2xl w-full h-full flex flex-col">
          ...
          <div className="content w-full h-full flex flex-col items-start justify-start px-20 py-10 overflow-scroll hide-scrollbar">
            ...
            <div className="details grid grid-cols-2 gap-4 w-full">
              <AboutMe biografia={user.biografia} />
              <Skills habilidades={user.habilidades} />
