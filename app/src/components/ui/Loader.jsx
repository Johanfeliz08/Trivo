export default function Loader({ message }) {
  return (
    <div className="loader absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40 flex flex-col justify-center items-center bg-[rgba(0,0,0,0.3)] w-screen h-screen">
