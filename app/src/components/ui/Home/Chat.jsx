    ...
    <>
      ...
      >
        <div className={`chats-bar hide-scrollbar overflow-y-scroll h-full ${isOpen ? "h-24 w-1/2 border-r border-gray-200" : ""}`}>
          <div className={`header flex flex-row justify-start items-center gap-4 ${isOpen ? "p-5 border-b border-gray-200" : ""}`}>
            <button
              className={`cursor-pointer flex gap-4 hover:bg-bg-secondary   ${
                isOpen ? "justify-start max-w-15 rounded-lg" : "border-l-5 border-transparent hover:border-primary transition-all justify-center"
            ...
            {isOpen && <span className="text-primary font-medium text-2xl">Mensajes</span>}
          </div>
            ...
            {mockData.map((chat) => {
              return (
                ...
                >
                  ...
                  <div className={`description flex-col justify-center items-start w-full ${isOpen ? "flex" : "hidden"}`}>
        ...
        <div className={`chat ${isOpen ? "flex flex-col w-full" : "hidden"}`}>
