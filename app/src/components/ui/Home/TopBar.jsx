...
import NotificationsList from "@/components/ui/Home/NotificationsList";
  ...
  return (
    <>
      <div className="topbar-container relative flex flex-row items-center w-full justify-center h-20 px-32 py-4 bg-white border-b-2 border-b-gray-200 shadow-sm z-50">
        ...
        <div className="right-section absolute right-12 gap-4 flex flex-row items-center justify-center h-full">
          <NotificationsList />
          <div className="dropdown-menu h-full flex flex-row justify-center items-center  cursor-pointer gap-4">
            ...
            <div className="menu h-[170px] overflow-hidden border absolute bg-white shadow-xl top-20 right-0 rounded-md w-full z-10">
              <nav className="">
                <ul className="flex flex-col gap-3">
                  ...
                  <li className="hover:bg-primary px-5 py-3 fill-primary hover:text-white hover:fill-white">
                    <a href="/configuracion" className="flex flex-row justify-start items-center gap-2">
                      <div className="icon">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
